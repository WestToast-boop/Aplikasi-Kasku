            ...
            <form action="config/submit_pembayaran.php"
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="info-box" id="pay_atas_nama">-</div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content p-4">
            ...
            <div class="modal-body text-center">
                ...
                <div class="mb-3">
                    <label class="form-label">Atas Nama</label>
                    <div class="info-box" id="detail_atas_nama">-</div>
                </div>
  ...
  modalBayar.addEventListener('show.bs.modal', function (event) {
    ...
    fetch("config/get_tagihan.php?id=" + encodeURIComponent(tId))
      ...
      .then(data => {
        ...
        document.getElementById("pay_atas_nama").innerText =
          data.atas_nama || "-";
  ...
  modalDetail.addEventListener('show.bs.modal', function (event) {
    ...
    fetch("config/get_tagihan.php?id=" + encodeURIComponent(tId))
      ...
      .then(data => {
        ...
        document.getElementById("detail_atas_nama").innerText =
          data.atas_nama || "-";
